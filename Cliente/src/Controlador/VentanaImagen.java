...
public class VentanaImagen extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGap(318, 318, 318)
                .addComponent(btn_cerrar, javax.swing.GroupLayout.PREFERRED_SIZE, 175, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    public void setUrl(URL url) {    
        initComponents();
        this.url = url;
        this.im = new Imagen(panel_imagen,this.url);
        panel_imagen.add(im).repaint();
    }
